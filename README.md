...
[![View My Profile](https://img.shields.io/badge/MEDIUM-Article-purple?logo=Medium)](https://medium.com/@albiecofie2000/a-classification-project-sepsis-prediction-with-machine-learning-fastapi-c351d2c892a4)
[![Docker App](https://img.shields.io/badge/Docker-App-yellow)](https://huggingface.co/spaces/AlbieCofie/Sepsis-Prediction-With-FastAPI)
[![Website](https://img.shields.io/badge/My-Website-darkgreen)](https://albiecofie2000.wixsite.com/home)

Develop a Machine Learning API (Application Programming Interface) using FastAPI.

![ai(3)](https://github.com/AlbieCofie/ML_API_Using_FastAPI)

## Introduction

We are embarking on an extensive machine learning endeavor centered around the prediction of sepsis using classification methods. Through the utilization of FastAPI, we have successfully deployed the model as an intuitive API, facilitating instantaneous predictions. The fusion of machine learning and web development holds tremendous promise in the healthcare domain, offering a substantial contribution to the early identification of sepsis and the improvement of patient well-being.
